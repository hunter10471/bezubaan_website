...
const DownloadSection = () => {
  ...
  return (
    <div className='w-[80vw] max-w-[1000px] mx-auto rounded-xl bg-heading flex md:flex-row flex-col-reverse items-center justify-between p-10 m-10 overflow-y-hidden'>
